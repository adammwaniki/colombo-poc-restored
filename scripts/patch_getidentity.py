f="/root/colombo-poc/_esignet-src/esignet-mock-services/mock-identity-system/src/main/java/io/mosip/esignet/mock/identitysystem/service/impl/IdentityServiceImpl.java"
src=open(f).read()
import re
NEW = r'''	@Override
...
m=re.search(r'[ \t]*@Override\n[ \t]*public JsonNode getIdentity\(String individualId\)[^\n]*\{', src)
assert m, "getIdentity not found"
...
print("patched getIdentity; replaced", end-start, "chars")
